...
Scenario: [Enter usedetails in the fraud capture application with Valid data]
	Given when I open the fraud capture  application
	And I enter the "vijay.kumar@gainwelltechnologies.com" on the welcome fraude capture page
	When I click on the Procced to login button on the welcome fraude capture page
	#And I enter the ping email address as  "vijay.kumar@gainwelltechnologies.com", the ping password as  "Vijay@103#618#@!", filled on the hms  page
	#And I enter the "PassCode", filled on the  hms  page
   # Then I should be navigated to fraud capture Page

Scenario: [Enter usedetails in the fraud capture application with invalid data]
	Given when I open the fraud capture  application
	And I enter the "test" on the welcome fraude capture page
	When I click on the Procced to login button on the welcome fraude capture page
	And I enter the ping email address as  "vijay.kumar@gainwelltechnologies.com", the ping password as  "Vijay@103#618#@!", filled on the hms  page
	And I enter the "PassCode", filled on the  hms  page
	Then I should be navigated to fraud capture Page
...
Scenario: [Enter use details and lead activity refferral in the fraud capture application]
	Given when I open the fraud capture  application
	And I enter the "vijay.kumar@gainwelltechnologies.com" on the welcome fraude capture page
	When I click on the Procced to login button on the welcome fraude capture page
	#And I enter the ping email address as  "vijay.kumar@gainwelltechnologies.com", the ping password as  "Vijay@103#618#@!", filled on the hms  page
	...
	When I enter  the lead id as "DEMO0102201901" on the fraud capture Lead table Page
	...
	When I click on the Activities on the fraud capture Lead detials Page
	Then I should be navigated to Lead Activities  Page

Scenario: [Enter use details and latest lead activity refferral in the fraud capture application]
	Given when I open the fraud capture  application
	When I enter the "vijay.kumar@gainwelltechnologies.com" on the welcome fraude capture page
...
Scenario: [Enter use details and audit in the fraud capture application]
	Given when I open the fraud capture  application
	And I enter the "vijay.kumar@gainwelltechnologies.com" on the welcome fraude capture page
	When I click on the Procced to login button on the welcome fraude capture page
	#And I enter the ping email address as  "vijay.kumar@gainwelltechnologies.com", the ping password as  "Vijay@103#618#@!", filled on the hms  page
	...
	Then I should be navigated to the Lead ID Details Page
	When I click on the Begin Editing on the fraud capture Lead detials Page
	When I click on the AuditLog on the fraud capture Lead audit detials Page
	Then I should be navigated to Lead Activities  Page

Scenario Outline: [Enter fraudcapture user data]
	Given when I open the fraudcapture application
	And I enter the "UserEmailID" in Welcome Page
	And I enter the "PingUserId" on the ping one Page
	And I enter the "PingPassword" on the ping one Page
	And I enter the "PingPassCode" on the ping one Page
	Then I should be navigated to the Next Page
	
	Examples: 
| UserEmailID                                    | PingUserId                                   | PingPassword  | PingPassCode 
| vijay.kumar@gainwelltechnologies.com           | vijay.kumar@gainwelltechnologies.com         | abc           | 1234 
