...
# Submitting Party Information page:
	...
	And the following fields should be displayed:
		...
		| <Organization1> | <NamePrefix> | <FirstName1> | <MiddleName1> | <LastName1> | <NameSuffix> | <StreetAddress3> | <StreetAddress4> | <City> | <Zip> | <Designation1> | <Country> | <PrimaryPhone> | <SecondaryPhone> | <Ssn> | <OtherId> | <Email1> | <Other> |
	And I enter the Text for How did this witness/external referring party report this? (Required) and Any Additonal Information regarding the witness or external referring party? (Optional)field on Second Time
...
Scenario Outline: 04_[Online Referral End To End Scenario with Primary Subject Type as Member and additional involved party as "Provider" along with Validation of all the required fields ]
...
Scenario Outline: 05_[Online Referral End To End Scenario with Primary Subject Type as Member and additional involved party as "Non-Enumerated Member" along with Validation of all the required fields ]
...
Examples:
	...
	Scenario Outline: 06_[Online Referral End To End Scenario with Primary Subject Type as Member and additional involved party as "Member" along with Validation of all the required fields ]
