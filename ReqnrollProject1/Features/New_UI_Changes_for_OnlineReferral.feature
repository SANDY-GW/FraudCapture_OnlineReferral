...
Scenario Outline: 01_ [ Under Submitting Party Information page validate Header appears aligned and not distorted,Required CSS glow appears,Required fields indicated in Admin Configuration appear in the portal,Dropdown lists are in alphabetical order,Email field require specific value formats,Zip Code fields require specific value formats ]
