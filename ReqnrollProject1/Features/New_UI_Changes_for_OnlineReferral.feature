...
Examples:
	...
	#Selecting Primary Subject as member with all the possible combinations



	#1. Selecting Primary Subject as member with additional involved party as "Provider" 
