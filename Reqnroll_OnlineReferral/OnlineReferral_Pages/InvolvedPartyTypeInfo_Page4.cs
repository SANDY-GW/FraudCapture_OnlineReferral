...
namespace FC_OnlineReferral.OnlineReferral_Pages
{
    public class InvolvedPartyTypeInfo_Page4 : BaseSettings
    {
        ...
        private readonly By proceed_To_Next_Section_Button = By.XPath("//button[text()='Proceed to Next Section']");
        private readonly By Go_To_Previous_Section_Button = By.XPath("//button[text()='Go To Previous Section']");
        private readonly By instructionButton = By.XPath("//button[text()='Instructions']");
        ...
        {
            CommonHelpers.WaitForElementClickable(Driver, proceed_To_Next_Section_Button, 10);
            Driver.FindElement(proceed_To_Next_Section_Button).Click();
        }
        public void ClickGoToPreviousSectionButton()
        {
            CommonHelpers.WaitForElementClickable(Driver, Go_To_Previous_Section_Button, 10);
            Driver.FindElement(Go_To_Previous_Section_Button).Click();
        }
        public void ClickGoToNextSectionButton()
        {
            CommonHelpers.WaitForElementClickable(Driver, proceed_To_Next_Section_Button, 10);
            Driver.FindElement(proceed_To_Next_Section_Button).Click();
        }
