...
namespace FC_OnlineReferral.FraudCapture_Pages.DataQueryExtraction.NewQuery
{
    public class NewQuery : BaseSettings
    {
        public NewQuery(IWebDriver driver) : base(driver) { }
