...
namespace FC_OnlineReferral.FraudCapture_Pages.CaseTrackingModule.CaseAndLeadReporting
{
    public class CaseTracking_CaseAndLeadReporting : BaseSettings
    {
        public CaseTracking_CaseAndLeadReporting(IWebDriver driver) : base(driver) { }
        ...
        //Add xpath here
       /// <summary>
       //private readonly By case = By.XPath("//a[@id='allLeadsTabId']");
       /// </summary>
