...
namespace FC_OnlineReferral.FraudCapture_Pages.CaseTrackingModule.LeadTab.WorkloadReassignment
{
    public class LeadWorkLoadReassignment : BaseSettings
    {
        public LeadWorkLoadReassignment(IWebDriver driver) : base(driver) { }
