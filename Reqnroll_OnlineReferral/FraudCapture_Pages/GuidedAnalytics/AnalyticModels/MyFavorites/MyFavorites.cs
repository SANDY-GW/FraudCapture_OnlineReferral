...
namespace FC_OnlineReferral.FraudCapture_Pages.GuidedAnalytics.AnalyticModels.MyFavorites
{
    public class MyFavorites : BaseSettings
    {
        public MyFavorites(IWebDriver driver) : base(driver) { }

        protected readonly WebDriverWait Wait;
        protected readonly TimeSpan DefaultTimeout = TimeSpan.FromSeconds(10);
        #region Elements
        private readonly By AnalyticModelsBtn = By.XPath("//a[contains(text(),'Analytic Models')]");
        private readonly By MyFavoritesBtn = By.XPath("//button[contains(text(),'My Favorites')]");
