...
namespace FC_OnlineReferral.FraudCapture_Pages.GuidedAnalytics.AnalyticModels.AllAnalytics
{
    public class AllAnalytics : BaseSettings
    {
        public AllAnalytics(IWebDriver driver) : base(driver) { }

        protected readonly WebDriverWait Wait;
        protected readonly TimeSpan DefaultTimeout = TimeSpan.FromSeconds(10);
        #region Elements
        private readonly By AnalyticModelsBtn = By.XPath("//a[contains(text(),'Analytic Models')]");
        private readonly By AllAnalyticsBtn = By.XPath("//button[contains(text(),'All Analytics ')]");
