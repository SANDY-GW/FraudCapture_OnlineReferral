...
namespace FC_OnlineReferral.FraudCapture_Pages.GuidedAnalytics.AnalyticModels.ProviderAnalytics
{
    public class ProviderAnalytics : BaseSettings
    {
        public ProviderAnalytics(IWebDriver driver) : base(driver) { }

        protected readonly WebDriverWait Wait;
        protected readonly TimeSpan DefaultTimeout = TimeSpan.FromSeconds(10);
        #region Elements
        private readonly By AnalyticModelsBtn = By.XPath("//a[contains(text(),'Analytic Models')]");
        private readonly By ProviderAnalyticsBtn = By.XPath("//button[contains(text(),'Provider Analytics')]");
