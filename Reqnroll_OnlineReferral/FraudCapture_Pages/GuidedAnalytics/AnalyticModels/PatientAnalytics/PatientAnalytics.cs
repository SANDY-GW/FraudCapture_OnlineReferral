...
namespace FC_OnlineReferral.FraudCapture_Pages.GuidedAnalytics.AnalyticModels.PatientAnalytics
{
    public class PatientAnalytics : BaseSettings
    {
        public PatientAnalytics(IWebDriver driver) : base(driver) { }

        protected readonly WebDriverWait Wait;
        protected readonly TimeSpan DefaultTimeout = TimeSpan.FromSeconds(10);
        #region Elements
        private readonly By AnalyticModelsBtn = By.XPath("//a[contains(text(),'Analytic Models')]");
        private readonly By PatientAnalyticsBtn = By.XPath("//button[contains(text(),'Patient Analytics')]");
