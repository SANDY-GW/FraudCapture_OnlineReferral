...
namespace FC_OnlineReferral.FraudCapture_Pages.GuidedAnalytics.AnalyticModels.GlobalAnalytics
{
    public class GlobalAnalytics : BaseSettings
    {
        public GlobalAnalytics(IWebDriver driver) : base(driver) { }

        protected readonly WebDriverWait Wait;
        protected readonly TimeSpan DefaultTimeout = TimeSpan.FromSeconds(10);
        #region Elements
        private readonly By AnalyticModelsBtn = By.XPath("//a[contains(text(),'Analytic Models')]");
        private readonly By GlobalAnalyticsBtn = By.XPath("//button[contains(text(),'Global Analytics')]");
